...
function esPrimo(numero) {
  ...
  if (numero !== 0 && numero !== 1) {
    ...
    //me haceguro que No es divisible por los valores entre 2 y numero-1
    for (let index = 2; index < absoluto; index++) {
      if (absoluto % index === 0) {
        return false; //es divisible , por lo tanto no es primo
      }
    }

    if (absoluto % 1 === 0 && absoluto % absoluto === 0) {
